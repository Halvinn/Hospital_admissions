...
```{r}
race_bar <- ggplot(discharges_clean, aes(Race)) +
    geom_bar() +
    theme(axis.text.x = element_text(angle = 45, vjust = 0.6))

gender_bar <- ggplot(discharges_clean, aes(Gender)) +
    geom_bar() +
    theme(axis.text.x = element_text(angle = 45, vjust = 0.6))
...
grid.arrange(race_bar, gender_bar, admi_type_bar, hsa_bar, nrow = 2, ncol = 2)
```
